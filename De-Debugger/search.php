...
<body id="search">
    ...
    <main>
        ...
        <div class="p-5 mb-4 rounded-3">
            <div class="container-fluid py-5">
                ...
                <p class="col-md-8 fs-4 text-light">Submit an error code or description and our advanced algorithm will
                    promptly search and provide you with the most suitable and informative tutorial to assist you in
                    fixing the issue.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        <input class="form-control mr-sm-2" id="searchTerm" type="text" placeholder="Search"
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h2 class="fw-normal text-light">Search Results</h2>
                </div>
                <div class="col-lg-3"></div>
            </div>
            <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3"></div>
                <div class="col-lg-6">
                    <h2 class="fw-normal text-light">Last Search</h2>
                </div>
                <div class="col-lg-3"></div>
            </div>
            <div class="row">
    ...
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-0 border-top text-bg-dark">
        ...
        <div class="col mb-3">
            <h5>Legal</h5>
            <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="privacy.html" class="nav-link p-0 text-muted">Privacy</a></li>
                <li class="nav-item mb-2"><a href="cookies.html" class="nav-link p-0 text-muted">Cookies</a></li>
